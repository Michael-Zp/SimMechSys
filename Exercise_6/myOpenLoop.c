 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon Jan 21 13:07:20 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME myOpenLoop
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void myOpenLoop_Outputs_wrapper(real_T *y0,
			const real_T *xC,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T *J = (const real_T *) mxGetData(PARAM_DEF2(S));
    const real_T *D = (const real_T *) mxGetData(PARAM_DEF3(S));
    const real_T *R = (const real_T *) mxGetData(PARAM_DEF4(S));
    
    myOpenLoop_Outputs_wrapper(y0, xC, L, p_width0, cm, p_width1, J, p_width2, D, p_width3, R, p_width4);
...
static void mdlDerivatives(SimStruct *S)
{
    ...
    myOpenLoop_Derivatives_wrapper(u0, y0, dx, xC, L, p_width0, cm, p_width1, J, p_width2, D, p_width3, R, p_width4);
