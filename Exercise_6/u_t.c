...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T *R = (const real_T *) mxGetData(PARAM_DEF3(S));
    const real_T *D = (const real_T *) mxGetData(PARAM_DEF4(S));
    
    u_t_Outputs_wrapper(u0, speed, xC, L, p_width0, cm, p_width1, J, p_width2, R, p_width3, D, p_width4);
...
static void mdlDerivatives(SimStruct *S)
{
    ...
    u_t_Derivatives_wrapper(u0, speed, dx, xC, L, p_width0, cm, p_width1, J, p_width2, R, p_width3, D, p_width4);
