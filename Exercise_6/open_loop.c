 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu Jan 24 15:04:47 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME open_loop
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void open_loop_Outputs_wrapper(const real_T *u0,
			real_T *speed,
			const real_T *xC,
...
extern void open_loop_Derivatives_wrapper(const real_T *u0,
			real_T *speed,
			real_T *dx,
			real_T *xC,
			const real_T *L, const int_T p_width0,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    real_T *speed = (real_T *) ssGetOutputPortRealSignal(S, 0);
    ...
    const real_T *L = (const real_T *) mxGetData(PARAM_DEF0(S));
    const real_T *cm = (const real_T *) mxGetData(PARAM_DEF1(S));
    const real_T *R = (const real_T *) mxGetData(PARAM_DEF2(S));
    const real_T *J = (const real_T *) mxGetData(PARAM_DEF3(S));
    const real_T *D = (const real_T *) mxGetData(PARAM_DEF4(S));
    
    open_loop_Outputs_wrapper(u0, speed, xC, L, p_width0, cm, p_width1, R, p_width2, J, p_width3, D, p_width4);
...
static void mdlDerivatives(SimStruct *S)
{
    ...
    open_loop_Derivatives_wrapper(u0, speed, dx, xC, L, p_width0, cm, p_width1, R, p_width2, J, p_width3, D, p_width4);
