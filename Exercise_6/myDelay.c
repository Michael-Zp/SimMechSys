 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon Jan 14 11:53:36 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME myDelay
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void myDelay_Outputs_wrapper(real_T *y0,
			const real_T *xC,
			const real_T *T, const int_T p_width0,
			const real_T *k, const int_T p_width1);
extern void myDelay_Derivatives_wrapper(const real_T *u0,
			real_T *y0,
			real_T *dx,
			real_T *xC,
			const real_T *T, const int_T p_width0,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T *k = (const real_T *) mxGetData(PARAM_DEF1(S));
    
    myDelay_Outputs_wrapper(y0, xC, T, p_width0, k, p_width1);
...
static void mdlDerivatives(SimStruct *S)
{
    ...
    myDelay_Derivatives_wrapper(u0, y0, dx, xC, T, p_width0, k, p_width1);
