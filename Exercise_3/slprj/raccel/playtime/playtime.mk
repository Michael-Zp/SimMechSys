...
MODEL               = playtime
MODULES             = rt_logging.c playtime.c playtime_capi.c playtime_data.c playtime_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c
MAKEFILE            = playtime.mk
...
MASTER_ANCHOR_DIR   = 
START_DIR           = C:/Users/mz-171742/Documents/GitHub/SimMechSys/Exercise_3
...
MODELLIB                  = playtimelib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = playtime_ref.rsp
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/playtime \
